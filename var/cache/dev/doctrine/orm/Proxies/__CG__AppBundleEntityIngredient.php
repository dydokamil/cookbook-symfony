...
class Ingredient extends \AppBundle\Entity\Ingredient implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Ingredient' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Ingredient' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Ingredient' . "\0" . 'icon', '' . "\0" . 'AppBundle\\Entity\\Ingredient' . "\0" . 'ingredient_step_joins'];
        }
    ...
    public function addRecipeStep(\AppBundle\Entity\RecipeStep $recipeStep)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addRecipeStep', [$recipeStep]);

        return parent::addRecipeStep($recipeStep);
    }
    ...
    public function removeRecipeStep(\AppBundle\Entity\RecipeStep $recipeStep)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeRecipeStep', [$recipeStep]);

        return parent::removeRecipeStep($recipeStep);
    }
    ...
    public function getRecipeSteps()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRecipeSteps', []);

        return parent::getRecipeSteps();
    }
